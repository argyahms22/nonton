  ...
  <body>
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <a href="#" class="navbar-brand"> <img src="images/logo.png" width="200" height="100" alt=""> </a>
            <span class="navbar-text">nonton</span>
            ...
            <ul class="navbar-nav">
              ...
              echo"<li class='nav-item'> <a href='account.php' class='nav-link'>Account</a> </li>
                  ...
                  <li class='nav-item'> <a href='#' class='nav-link'>TV Show</a> </li>
                  <li class='nav-item'> <a href='#' class='nav-link'>Movies</a> </li>
                  <li class='nav-item'> <a href='#' class='nav-link'>Kids</a> </li>
                  <li class='nav-item dropdown'><a href='#' class='nav-link'>Menu 3</a>
                    <ul class='isi-dropdown'>
                      ...
                      <li class='nav-item'><a href='#' class='nav-link'>Fantasy Team </a></li>
                    </ul>
                  </li>  
